...
define( 'YOURLS_DB_USER', 'ezyro_25503667' );

/** MySQL database password */
define( 'YOURLS_DB_PASS', '1qli62iu' );

/** The name of the database for YOURLS */
define( 'YOURLS_DB_NAME', 'ezyro_25503667_hb' );

/** MySQL hostname.
 ** If using a non standard port, specify it like 'hostname:port', eg. 'localhost:9999' or '127.0.0.1:666' */
define( 'YOURLS_DB_HOST', 'sql300.ezyro.com' );
...
define( 'YOURLS_SITE', 'http://hb.ezyro.com' );
